...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back = findViewById(R.id.bt_BackButton);

        TextView UserNameView = findViewById(R.id.tv_UserNameSecond);
        UserNameView.setText(getIntent().getExtras().getString("UserNamePass"));

        TextView PasswordView = findViewById(R.id.tv_PasswordSecond);
